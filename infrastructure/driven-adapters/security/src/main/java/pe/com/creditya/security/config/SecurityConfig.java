    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers(HttpMethod.POST, APPLICATIONS_PATH).hasAnyRole(Constants.ROLE_USER)
                        .pathMatchers(HttpMethod.GET, APPLICATIONS_PATH).hasAnyRole(Constants.ROLE_ADVISOR)
